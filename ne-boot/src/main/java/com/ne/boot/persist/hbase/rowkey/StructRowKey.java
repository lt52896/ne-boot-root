...
package com.ne.boot.persist.hbase.rowkey;
...
public class StructRowKey extends RowKey implements Iterable<Object> {
     ...
     */
        for (int i = o.length - 1; i >= 0; i--) {
            if (fieldTerm == Termination.SHOULD_NOT || fields[i].getTermination() != Termination.SHOULD_NOT) // SHOULD_NOT always wins
